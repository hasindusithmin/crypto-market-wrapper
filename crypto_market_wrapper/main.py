...
class Crypto():
    ...
    def GET_RECENT_TRADES_LIST(SELF,SYMBOL="BTCUSDT"):
        """
    ...
    def GET_AGGREGATE_TRADES_LIST(SELF,SYMBOL="BTCUSDT"):
        """
    ...
    def GET_CANDLESTICK_DATA(SELF,SYMBOL="BTCUSDT",INTERVAL="1h",LIMIT=500):
        """
    ...
    def GET_UIKLINES(SELF,SYMBOL="BTCUSDT",INTERVAL="1h",LIMIT=500):
        """
        The function provides a DataFrame containing candlestick data.
    ...
    def GET_CURRENT_AVERAGE_PRICE(SELF,SYMBOL="BTCUSDT"):
        """
    ...
    def GET_TICKER_PRICE_CHANGE_24H(SELF,SYMBOLS=["BTCUSDT"]):
        """
    ...
    def GET_SYMBOL_ORDER_BOOK_TICKER(SELF,SYMBOLS=["BTCUSDT"]):
        """
